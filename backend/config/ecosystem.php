...
return [
    ...
    |
    | Local divergence from the shared source: the 'charts' entry is flipped
    | to active with its real production URL -- Dot.Charts went live at
    | charts.infodot.co.za on 2026-09-01, after the shared registry was last
    | synced. Fold this back into InfoDot's copy at the next registry sync.
    */
    ...
    'platforms' => [
        ...
        'charts' => ['name' => 'Dot.Charts', 'url' => env('DOT_CHARTS_URL', 'https://charts.infodot.co.za'), 'icon' => 'candlestick_chart', 'accent' => '#22d3ee', 'active' => true],
